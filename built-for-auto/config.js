let titleDiv = 
'<img src="../images/MAS-Full-BY.png" alt="MAS Logo" height=45px width=auto><p></p>'
...
var config = {
  ...
  chapters: [
    ...
    { id: "auto-03",
      ...
      hidden: false,
      chapterDiv: 
      '<p class="p-center">That includes more than 120,000 trucks that enter and exit the city daily, primarily along the city’s arterials because most are designated as truck routes and connect to distribution centers and industrial areas.</p>'
      +'<figure>'
    ...
    { id: 'auto-08',
      ...
      +'<dl><dt><strong>Legend</strong></dt>'
        +'<dd><svg width="17" height="12"><rect width="10" height="10" x="1" y="1" style="fill:#b5caed" /></svg>Less than 20% of population in census tract takes public transportation to work</dd>'
    ...
    { id: 'auto-12',
      ...
      hidden: false,
      chapterDiv:
      '<p>Arterials lined with alternate side parking forces taxis and delivery drivers to double park in spaces intended for vehicle movement or pedestrian use in order to complete pickups and deliveries.</p>'
      +'<figure>'
    ...
    { id: 'auto-13',
      ...
      hidden: false,
      chapterDiv: 
      '<p>The rightmost travel lane along numerous corridors is rendered virtually useless as a result.</p>'
      +'<figure>'
