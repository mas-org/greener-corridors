...
var config = {
  ...
  chapters: [
    ...
    { id: 'auto-21',
      alignment: 'centered',
      hidden: false,
      chapterDiv: '<p>Yet even with ongoing and proposed improvements, these corridors are not being optimized to their full potential, with mobility being just one focus area. There is an opportunity to make stroads significantly greener in terms of trees and vegetation and to encourage more sustainable development. The need to leverage them is all the more urgent given the climate crisis and transportation’s role as the largest contributor to greenhouse gas emissions in the country. For those who have the choice of how to travel, dangerous, unpleasant, and car-oriented street conditions reinforce a vicious cycle where driving becomes the preferred option. In the next storymap, we explore issues of heat and flooding and opportunities to make these corridors more climate resilient.</p>'
